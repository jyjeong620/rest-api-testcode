...
public class SetTest {
  ...
  void contains(final String input) {
  ...
  void containTrueFalseCheck(final String input, final String expected) {
    assertThat(this.numbers.contains(Integer.parseInt(input)))
